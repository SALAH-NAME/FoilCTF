...
import { users, profiles, sessions, ctfs, ctf_organizers, teams, team_members, team_join_requests, friends, friend_requests, challenges, challenges_attachments, attachments, hints, participations, ctfs_challenges, solves, containers, notification_users, notifications, chat_rooms, messages, reports } from "./schema.js";
