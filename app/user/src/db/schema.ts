...
export const users = pgTable(
	...
	(table) => [
		...
		check(
			'users_role_check',
			sql`(role)::text = ANY ((ARRAY['user'::character varying, 'admin'::character varying])::text[])`
		),
	]
);
...
export const ctf_organizers = pgTable(
	'ctf_organizers',
	{
...
export const team_join_requests = pgTable(
	'team_join_requests',
	{
		team_name: text().notNull(),
		username: text().notNull(),
...
export const challenges_attachments = pgTable(
...
export const ctfs_challenges = pgTable(
	'ctfs_challenges',
	{
		ctf_id: integer().notNull(),
		challenge_id: integer().notNull(),
...
export const notification_users = pgTable(
	'notification_users',
	{
