...
export const team_join_requestsRelations = relations(
	team_join_requests,
	({ one }) => ({
		team: one(teams, {
...
export const challenges_attachmentsRelations = relations(
	challenges_attachments,
	({ one }) => ({
...
export const ctfs_challengesRelations = relations(
	ctfs_challenges,
	({ one, many }) => ({
		ctf: one(ctfs, {
...
export const notification_usersRelations = relations(
	notification_users,
	({ one }) => ({
		user: one(users, {
